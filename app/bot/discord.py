...
class FootballBotClient(discord.Client):
    ...
    async def notify_organizer(self, organizer_user_id: str, player_name: str, game_id: int, game_location: str, game_date: str, game_time: str, request_id: int, position: str = None):
        ...
        try:
            ...
            msg = (
                ...
                f"<@{player_name}> quiere unirse a tu partido #{game_id}{position_text}.\n"
        ...
        try:
            ...
            if metadata and metadata.get("notify_organizer"):
                ...
                await self.notify_organizer(
                    ...
                    player_name=notify.get("player_platform_user_id", message.author.id),
